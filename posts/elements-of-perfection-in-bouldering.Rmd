...
```{r echo=FALSE, out.width='100%', fig.cap = "Die boogskutter, 7c+ - about 13 moves in total. It starts with a series of compression undercling moves which traverses into steep overhanging arete climbing on positive holds. The topout sequence is the crux: you move into a full extension lockoff from a strange position all the way up to a terrible 1/4 digit crimp; after which you make a big move with the right hand to an OK hold. And the topout is not a giveaway either."}
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/boogskutter.png')
```
...
```{r echo=FALSE, out.width='100%', fig.cap = "The unmoved mover, 7c+ - 6 moves in total with an extremely low percentage crux move: a dyno from a sloper and a crimp on a strangely overhanging arete to another alright one-digit crimp."}
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/unmoved-mover1.png')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/beyond-good-and-evil.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/power-of-madness.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/sondvloed.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/morphic-resonance1.jpg')
```
...
```{r echo=FALSE, out.width='80%', fig.cap = "Die kompoun, 7b+ - starting with compression moves in a near-horizontal roof, climbing into strange open-handed huecos and topping out with a technical slab. Die kompoun!"}
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/kompoun.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/oil-arete.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/mensvretergees.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/handlanger1.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/slang-se-resiprook.jpg')
```

Having fun on the Ietermagog.

```{r echo=FALSE, out.width='100%', fig.cap = "Die ietermagog, 7a - sloping arete weirdness."}
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/ietermagog.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/oilpainting2.jpg')
```

Another project Jurie and I tried one afternoon must rank in my top 5 boulders ever. Let's start with the setting:

```{r echo=FALSE, fig.fullwidth=TRUE}
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/skepe-proj3.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/skepe-proj2.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/skepe-proj1.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/nulle-proj-voor2.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/sky-ish-proj.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/godwording.png')
```

```{r echo=FALSE, out.width='100%', fig.cap = "Jeanrich moving into the crux sequence on the span roof project: with a left heel and a right hand pinch in the 45 degree roof you move to a tiny 1/3 digit crimp with your left hand; then you move your left heel to a toe and do a huge strecth with the left hand to another more positive pinch. At this point you need to resist the urge to cut loose and do a cross-over with the right hand to another positive hold. And then comes the cutloose."}
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/span-roof-proj.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/rail-proj.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/mensdier.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/ondier-proj.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/magic-wallet.jpg')
```
...
knitr::include_graphics('/Users/leondutoit/leondutoit.github.io/posts/media/bouldering/baba.jpg')
```
...
Other worthwhile approaches to naming involve referencing literature, philosophy, politics or connecting with shapes and features of boulders. Sometimes a specific movement provides inspiration. A beautiful boulder that climbs well deserves a good name and there is a certain amount of satisfaction when you manage to find one.

## Remembering

The way you remember things is closely related to how you describe them and talk about them. If you pay attention to the many facets of the bouldering experience and if you cultivate a nuanced vocabulary for describing these experiences you will be lucky to have rich memories of your ascents and your attempts. You will be lucky to avoid simplistic and generic experiences that are disconnected from the landscape and the context^[Crushed another sick rig; made quick work of this soft 8a; 10 minutes; should have flashed it; low-end whatever, #betterThanYou, #validateMe.].

Developing your capacity to experience and describe your climbing experiences, via its impact on your memories and subsequent conversations, also affects the structure and the sustainability of your motivation. After the month of July I feel overwhelmed with inspiration to train and improve so that I can return to my projects and continue the search for the many elements of perfection in bouldering.
